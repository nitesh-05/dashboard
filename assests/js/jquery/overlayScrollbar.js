(function (global, factory) {
  ...
  var COMPATIBILITY = (function () {
    ...
    return {
       ...
       */
      rAF: bind(VENDORS._jsAPI, 0, "requestAnimationFrame", false, function (
        func
      ) {
       ...
       */
      cAF: bind(VENDORS._jsAPI, 0, "cancelAnimationFrame", false, function (
        id
      ) {
  ...
  var PLUGIN = (function () {
    ...
    function OverlayScrollbarsInstance(
      ...
      function setupResponsiveEventListener(
        ...
        var collected =
          type(eventNames) == TYPES.a && type(listener) == TYPES.a;
        ...
        if (targetElement) {
          ...
          if (onElementResizedCallback) {
            ...
            if (targetElement[0] === _sizeObserverElementNative) {
              ...
              directionChanged();
              addDestroyEventListener(targetElement, _strScroll, function (
                event
              ) {
              ...
              each(mutations, function () {
                ...
                if (!doUpdate) {
                  if (mutationAttrName === LEXICON.c)
                    doUpdate = hostClassNamesChanged(
                      mutation.oldValue,
                      mutationTarget.className
                    );
                  else if (mutationAttrName === LEXICON.s)
                    doUpdate =
                      mutation.oldValue !== mutationTarget[LEXICON.s].cssText;
                  else doUpdate = true;
                }
      ...
      function hostClassNamesChanged(oldCassNames, newClassNames) {
        var currClasses =
          newClassNames !== undefined && newClassNames !== null
            ? newClassNames.split(_strSpace)
            : _strEmpty;
        var oldClasses =
          oldCassNames !== undefined && oldCassNames !== null
            ? oldCassNames.split(_strSpace)
            : _strEmpty;
        if (currClasses === _strEmpty && oldClasses === _strEmpty) return false;
        var diff = getArrayDifferences(oldClasses, currClasses);
        var changed = false;
        var oldClassNames =
          _oldClassName !== undefined && _oldClassName !== null
            ? _oldClassName.split(_strSpace)
            : [_strEmpty];
        var currClassNames =
          _classNameCache !== undefined && _classNameCache !== null
            ? _classNameCache.split(_strSpace)
            : [_strEmpty];
        ...
        if (
          ...
          if (
            ...
            return hostClassNamesChanged(
              mutation.oldValue,
              mutationTarget.getAttribute(LEXICON.c)
            );
          ...
          if (
            ...
            mutationTarget[strClosest](_strDot + _classNameScrollbar) !==
              null ||
            mutationTarget[strClosest](_strDot + _classNameScrollbarCorner) !==
              null
          )
            return false;
        }
      ...
      function update(updateHints) {
        ...
        _nativeScrollbarMinSize = {
          x:
            (_nativeScrollbarSize.x + (_nativeScrollbarIsOverlaid.x ? 0 : 3)) *
            3,
          y:
            (_nativeScrollbarSize.y + (_nativeScrollbarIsOverlaid.y ? 0 : 3)) *
            3,
        };
        ...
        displayIsHidden =
          displayIsHidden === undefined
            ...
            : displayIsHidden;
        var displayIsHiddenChanged = checkCacheAutoForce(
          displayIsHidden,
          _displayIsHiddenCache
        );
        ...
        var padding = {
          ...
          r: parseToZeroOrNumber(
            _hostElement.css(_strPaddingMinus + _strRight)
          ),
          b: parseToZeroOrNumber(
            _hostElement.css(_strPaddingMinus + _strBottom)
          ),
        ...
        var border = {
          ...
          t: updateBorderY
            ? parseToZeroOrNumber(
                _hostElement.css(_strBorderMinus + _strTop + strMinusWidth),
                true
              )
            : 0,
          r: updateBorderX
          ...
          b: updateBorderY
            ? parseToZeroOrNumber(
                _hostElement.css(_strBorderMinus + _strBottom + strMinusWidth),
                true
              )
            : 0,
          l: updateBorderX
        ...
        var margin = {
          ...
          b: parseToZeroOrNumber(
            _hostElement.css(_strMarginMinus + _strBottom)
          ),
        ...
        if (
          ...
          if (sizeAutoCapable) {
            ...
            var setContentGlueElementCSSfunction = function (horizontal) {
              ...
              var maxSize =
                ...
                (_isBorderBox ? borderSize : -paddingSize);

              //make contentGlue size -1 if element is not auto sized, to make sure that a resize event happens when the element shrinks
              if (!autoSize || (!autoSize && border.c))
                contentGlueElementCSS[strWH] =
                  hostSize[wh] -
                  (_isBorderBox ? 0 : paddingSize + borderSize) -
                  1 -
                  marginSize;
              ...
              if (
                autoSize &&
                cssMaxValue["c" + wh] &&
                cssMaxValue["i" + wh] === maxSize
              )
                contentGlueElementCSS[strWH] =
                  maxSize + (_isBorderBox ? 0 : paddingSize) + 1;

              //if size is auto and host is smaller than size as min size, make content glue size -1 to make sure size changes will be detected (this is only needed if padding is 0)
              if (
                autoSize &&
                contentSize[wh] < _viewportSize[wh] &&
          ...
          var showScrollbarH = COMPATIBILITY.bind(
          ...
          var showScrollbarV = COMPATIBILITY.bind(
            refreshScrollbarAppearance,
            0,
            false,
            true,
          ...
          var hideScrollbarH = COMPATIBILITY.bind(
            refreshScrollbarAppearance,
            0,
            true,
            false,
          ...
          var hideScrollbarV = COMPATIBILITY.bind(
            refreshScrollbarAppearance,
            0,
            false,
            false,
          ...
          else removeClass(_hostElement, _classNameHostOverflowY);
      ...
      function setupScrollbarEvents(isHorizontal) {
        ...
        function onTrackMouseTouchDown(event) {
          if (onMouseTouchDownContinue(event)) {
            ...
            var trackOffset = scrollbarVars._track.offset()[
      ...
      function refreshScrollbarHandleLength(isHorizontal) {
        ...
        var handleRatio = MATH.min(
          1,
          (_hostSizeCache[scrollbarVars._w_h] -
            (_paddingAbsoluteCache
              ? isHorizontal
                ? _paddingX
                : _paddingY
      ...
      function getHostElementInvertedScale() {
        ...
        return {
          x: _supportTransform
            ? 1 /
                (MATH.round(rect.width) / _paddingElementNative[LEXICON.oW]) ||
              1
            : 1,
          y: _supportTransform
            ? 1 /
                (MATH.round(rect.height) / _paddingElementNative[LEXICON.oH]) ||
              1
            : 1,
        };
      }
